...
public interface CouponRepo extends JpaRepository<Coupon, Integer> {
	...
	@Transactional
	@Modifying
	@Query(value = "INSERT INTO bcs.customers_coupons (customer_id, coupons_id) VALUES (:customerID, :couponID)", nativeQuery = true)
	void addCouponPurchase(int customerID, int couponID);

	@Transactional
	@Modifying
	@Query(value = "DELETE from bsc.customers_coupons WHERE customer_id=:customerID AND coupons_id=:couponID", nativeQuery = true)
